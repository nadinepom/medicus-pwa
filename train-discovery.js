/*
Replace the accesses to the IBM Watson Discovery
   Version: 17/01/2019
   Author: mamoonraja
   URL: https://github.com/watson-developer-cloud/assistant-with-discovery-openwhisk/blob/master/train-discovery.js
*/
...
const collectionName = 'healthDiscovery';
...
/**
 * CameraPhoto all the documents in discovery-documents
 * @param  {Object}   params
 * @param  {String}   env_id
