/*
Structure of the chatbot and the website.
   Version: 17/01/2019
   Author: mamoonraja
   URL: https://github.com/watson-developer-cloud/assistant-with-discovery-openwhisk/blob/master/src/App.js
*/

import React, {Component} from 'react';
import './Application.css';
import Conversation from './components/Conversation.js';
import DiscoveryResult from './components/DiscoveryResult.js';
  ...
  formatDiscovery(resultArr) {
    resultArr.map(function (result, index) {
      const formattedResult = <DiscoveryResult
        ...
        substance={result.name}
        dosage={result.sourceUrl}
        id={result.id}/>;
      ...
      <div>
        ...
        <div className="container ">
          ...
          <div className="row margin-8">
            <div className="mobile-hide col-xs-12 col-sm-4 col-lg-3">
              <div className="card vh100">
                <video src={bot_horizontal} autoPlay loop muted playsInline poster={boti2}>Medicus Aninmation</video>
                <div className="card-body">
                  <p className="card-title">Du kannst mich z.B. Folgendes fragen:</p>
                  <div className="row">
                    <div className="col-2">
                      <svg width="35px" height="32px" viewBox="0 0 35 32" version="1.1"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none"
                          fillRule="evenodd">
                          <g id="W/100_FragMedicus"
                            transform="translate(-48.000000, -368.000000)" fill="#FF6600">
                            <g id="Card_Max" transform="translate(48.000000, 104.000000)">
                  ...
                  <div className="row">
                    <div className="col-2">
                      <svg width="24px" height="33px" viewBox="0 0 24 33" version="1.1"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none"
                          fillRule="evenodd">
                          <g id="W/100_FragMedicus"
                            transform="translate(-54.000000, -432.000000)" fill="#73E3B9">
                            <g id="Card_Max" transform="translate(48.000000, 104.000000)">
                              <g id="Group-2" transform="translate(0.000000, 192.000000)">
                                <g id="Group"
                  ...
                  <div className="row">
                    <div className="col-2">
                      <svg width="32px" height="32px" viewBox="0 0 32 32" version="1.1"
                        ...
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none"
                          fillRule="evenodd">
                          <g id="W/100_FragMedicus"
                            transform="translate(-50.000000, -496.000000)" fill="#00CAFF">
                            <g id="Card_Max" transform="translate(48.000000, 104.000000)">
                              <g id="Group-2" transform="translate(0.000000, 192.000000)">
                                <g id="Group"
                    ...
                    <div className="col-10">
                      ...
                      <p className="card-text">"Wie häufig darf ich Nasenspray benutzen?"</p>
                    </div>
                  </div>
                </div>
                <hr className="new-hr"/>
                <p className="card-text small-text">Zu Risiken und Nebenwirkungen lesen Sie die
                                    Packungsbeilage und
                                    fragen
                                    Sie Ihren Arzt oder
                                    Apotheker.</p>
